                                    ...
                                    <div id="deleteModal-{{ $post->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer"
                                                    data-modal-toggle="deleteModal-{{ $post->id }}">
                                                ...
                                                <div class="flex justify-center items-center space-x-4">
                                                    ...
                                                    <form action="/dashboard/{{ $post->slug }}" method="POST">
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900 cursor-pointer">Yes,
                                                            I'm sure</button>
                                                    </form>
                                                </div>
                                            </div>
